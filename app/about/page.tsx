        ...
        <main className="bg-white">
            ...
            <section className="py-20 md:py-32 bg-slate-950">
                <div className="max-w-6xl mx-auto px-6 text-center">
                    <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-12">
                        Our Vision
                    </h2>
            ...
            <section className="py-20 md:py-32 bg-white">
                <div className="max-w-5xl mx-auto px-6">
                    <h2 className="font-serif text-4xl md:text-5xl font-bold text-slate-900 mb-20 text-center">
                        Our Core Values
                    </h2>
                    ...
                    <div className="space-y-24">
                        ...
                        <div className="relative">
                            <div className="absolute -left-4 md:-left-8 top-0 text-[120px] md:text-[180px] font-bold text-slate-200 leading-none select-none">
                                01
                            </div>
                            <div className="relative z-10 pl-16 md:pl-32">
                                <div className="flex items-start gap-4 mb-4">
                                    <Target className="w-10 h-10 text-orange-500 flex-shrink-0 mt-1" />
                        ...
                        <div className="relative">
                            ...
                            <div className="relative z-10 pl-16 md:pl-32">
                                <div className="flex items-start gap-4 mb-4">
                                    <Shield className="w-10 h-10 text-orange-500 flex-shrink-0 mt-1" />
                                    <h3 className="font-serif text-3xl md:text-4xl font-bold text-slate-900">
                                        Integrity
                                    </h3>
                                </div>
            ...
            <section className="py-20 md:py-24 bg-stone-50">
                <div className="max-w-4xl mx-auto px-6 text-center">
                    ...
                    <Link
                        href="/profile"
                        className="inline-flex items-center gap-3 bg-orange-500 hover:bg-orange-600 text-white font-semibold px-8 py-4 rounded-none transition-all duration-300 text-lg group"
                    >
                        Meet Our Director
